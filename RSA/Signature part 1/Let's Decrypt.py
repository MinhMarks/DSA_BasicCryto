...
print(readline())
'''b'This server validates domain ownership with RSA signatures.
Present your message and public key, 
and if the signature matches ours, you must own the domain.'
b'{"msg": "Congratulations, here's a secret: 
